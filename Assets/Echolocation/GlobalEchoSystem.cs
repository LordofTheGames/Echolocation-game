...
public class GlobalEchoSystem : MonoBehaviour
{
    ...
    public static void Ping(Vector3 position) // Can add things later like: shape of projection + rotation, loudness, pitch, num rays (if not dependent on other things), etc.
    {
    ...
    void SpawnPulse(Vector3 position)
    {
